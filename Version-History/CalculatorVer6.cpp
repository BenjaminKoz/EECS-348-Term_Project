...
double parser(const string& expression){
    ...
    for (int i = 0; i < expression.size(); i++){
        if (isspace(expression[i])){
            ...
            continue;
        } else if (expression[i] == '+' && (expression[i+1] == 'p' || expression[i+1] == 'e' || isdigit(expression[i+1]))){
            continue;
            ...
            if(!(( (isdigit(expression[i-2]) || (expression[i-2] == 'i' && expression[i-3] == 'p') || expression[i-2] == 'e') || expression[i-2] == ')') || ( ( isdigit(expression[i+2]) || (expression[i+2] == 'p' && expression[i+3] == 'i') || expression[i+2] == 'e' ) || expression[i+2] == '('))){
    ...
    try {
        ...
        for (int i = 0; i < inputString.size(); i++){;
            if (isspace(inputString[i])){
                ...
                continue;
            } else if ((inputString[i] == '-' || inputString[i] == '+') && inputString[i+1] == '('){
                continue;
                ...
                operands++;
            } else if (inputString[i] == 'p' || inputString[i] == 'e'){
                if (inputString[i] == 'e') i++;
                else i++; i++;
                operands++;
            } else if (inputString[i] == '-' && (inputString[i+1] == 'p' || inputString[i+1] == 'e')) {
                i++;
                if (inputString[i] == 'e') i++;
                else i++; i++;
                operands++;
        ...
        if (operands != operators){
            throw "Invalid combinations of operators and operands, or invalid spacing.";
        }
